    ...
    <>
      ...
      <div className="flex items-center justify-between ">
        <div className="container relative flex flex-col items-center justify-between gap-10 mx-auto lg:flex-row lg:py-20 py-14 lg:gap-0 ">
          ...
          >
            <div className="gap-8 flex flex-col justify-center  *:tracking-wide    rounded-lg px-8 py-10 dark:shadow-[0_0px_15px_#ffffff20]    shadow-[0_0px_15px_#00000010]  backdrop-blur-[20px] dark:backdrop-blur-[10px] bg-[rgba(255,255,255,0.2)]   dark:bg-[rgba(255,255,255,0.05)]">
              {children}
            </div>
          </LayoutTransition>
        </div>
